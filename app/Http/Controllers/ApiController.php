...
use App\BlogPostsService\Transformers\Transformer;

class ApiController extends Controller
{
    /** \App\BlogPostsService\Transformers\Transformer
     *
     * @var null
     */
    ...
    {
        return $this->respondWithTransformer($data, 201);
    }
    /**
    ...
    /**
     * Respond with validation errros.
     *
     * @return \Illuminate\Http\JsonResponse
     */
    protected function respondValidationErrors($errors, $message='Validation failed')
    {
        return $this->respond([
            'errors' => [
                'message' => $message,
